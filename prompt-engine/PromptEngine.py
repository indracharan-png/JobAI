"""PromptEngine module for resume/job-description analysis.

This file was copied from the backend job analysis service so the prompt logic is
visible in GitHub and easier to review in one place.
"""
